...
class Match implements Taskable {
    ...
    public function __construct($match_id, $server_ip, $rcon) {
        ...
        try {
            ...
            $this->rcon->send("log on; mp_logdetail 1; logaddress_del " . \eBot\Config\Config::getInstance()->getBot_ip() . ":" . \eBot\Config\Config::getInstance()->getBot_port() . ";logaddress_add " . \eBot\Config\Config::getInstance()->getBot_ip() . ":" . \eBot\Config\Config::getInstance()->getBot_port());
