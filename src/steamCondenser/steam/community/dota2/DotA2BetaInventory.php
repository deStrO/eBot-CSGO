...
GameInventory::$cache['DotA2BetaInventory'] = array();
...
class DotA2BetaInventory extends GameInventory {
    ...
    public static function clearCache() {
        parent::$cache['DotA2BetaInventory'] = array();
    }
    ...
    public static function create($steamId64, $fetchNow = true, $bypassCache = false) {
        if(self::isCached($steamId64) && !$bypassCache) {
            $inventory = parent::$cache['DotA2BetaInventory'][$steamId64];
    ...
    public static function isCached($steamId64) {
        return array_key_exists($steamId64, parent::$cache['DotA2BetaInventory']);
    }
